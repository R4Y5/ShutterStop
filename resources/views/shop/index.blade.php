        ...
        <form id="filterForm" method="GET" action="{{ route('shop.index') }}" class="row g-3">
            ...
            <div class="col-md-1">
                ...
                <select name="type" class="form-select">
                    ...
                    <option value="service" {{ request('type') == 'service' ? 'selected' : '' }}>Svc</option>
                    <option value="product" {{ request('type') == 'product' ? 'selected' : '' }}>Prod</option>
                </select>
            </div>
            ...
            <div class="col-md-1">
                ...
                <input type="number" name="max_price" value="{{ request('max_price') }}" class="form-control" placeholder="9k">
            </div>
...
@@ -116,6 +200,3 @@ function submitFilters() {
});
</script>
@endsection